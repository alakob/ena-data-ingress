...
experiment_accession <- metadata_clean$experiment_accession
sample_accession <- metadata_clean$sample_accession
...
metadata_clean$experiment_accession <- experiment_accession
metadata_clean$sample_accession <- sample_accession
```
...
```{r}
library(DT)
datatable(metadata_clean, escape=FALSE)
```          
...
datatable(metadata_clean, filter = 'top',  escape=FALSE,
...
metadata_clean %>% datatable( extensions = 'Buttons',  escape=FALSE,
